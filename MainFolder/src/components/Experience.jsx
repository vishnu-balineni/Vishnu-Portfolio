      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A timeline of my roles in AI research, backend development, and agentic systems.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="Present"
            title={<>Full Stack Developer Intern @ <a href="#" className="underline hover:text-red-400 transition-colors">Nabes Pvt Ltd</a></>}
            text="Engineered scalable HRMS using React and Spring Boot microservices. Implemented RBAC and optimized PostgreSQL database queries."
            className="md:absolute md:top-[120px] md:left-[25%] lg:left-[35%] -rotate-2 md:-rotate-3"
            aosType="fade-up"
            aosDelay="100"
